...
describe('UserSignupPage', () => {
  ...
  describe('Interactions', () => {
    ...
    it('does not allow user to click signup button when there is an ongoingapi call', () => {
      const actions = {
    ...
    it('displays pinner when there is an ongoing api call', () => {
      const actions = {
        postSignup: mockAsyncDelayed()
      };
    ...
    it('hides spinner fter api call finishes success',async () => {
      const actions = {
        postSignup: mockAsyncDelayed()
      };
      const {queryByText} = setupForSubmit({ actions });
